#(c) Adam Pridgen adam.pridgen@thecoverofnight.com, adam@praetoriangrp.com
# convert_decode_strings - decode and comment on encoded strings in the binary
import binascii
...
max_str_length = AskLong(37, "Enter an alignment (37) by default.")
